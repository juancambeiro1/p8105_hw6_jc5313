...
variable and to make a binary `case_solved` variable, as well as to
ensure appropriate data types. I use `filter` to omit the following
cities: Dallas, TX; Phoenix, AZ; Kansas City, MO; Tulsa, AL. I also use
`filter` to limit the analysis to those victim_race is White or Black.
