...
**Description of tidied data:** There are now `r nrow(birthweight_tidy)` observations and `r ncol(birthweight_tidy)` variables in the dataset. There are `r sum(is.na(birthweight_tidy))` missing values.
